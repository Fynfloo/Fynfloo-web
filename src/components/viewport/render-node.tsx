...
import { RenderNodeProps } from '../../types/render-node';
import ReactDOM from 'react-dom';
import styled from 'styled-components';
import { Move, ArrowUp, Trash2 } from 'lucide-react';
import { ROOT_NODE } from '../../types/craft-component';
    ...
    <>
      {isHover || isActive
        ? ReactDOM.createPortal(
            <IndicatorDiv
              ref={currentRef}
              className="px-2 py-2 text-primary-foreground bg-primary fixed flex items-center"
              style={{
