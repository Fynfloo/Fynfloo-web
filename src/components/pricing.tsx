...
const tiers = [
  {
    ...
    priceMonthly: 'Free',
    description:
      'Perfect for launching your first online store with essential features.',
    features: [
      'Up to 25 products',
  ...
  },
  {
    ...
    href: '/signup',
    priceMonthly: '£5',
    description: 'Advanced tools and priority support for growing businesses.',
    features: [
      'Unlimited products',
    ...
    <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mt-6 text-lg text-gray-700">
          Affordable plans with everything you need to build, grow, and manage
